...
public class NPCCarManager2 : MonoBehaviour
{
    ...
    private void SpawnCar()
    {
        ...
        GameObject car = Instantiate(carPrefab, spawnPosition, carPrefab.transform.rotation);
        float speedModifier = Random.Range(0.8f, 1.1f); // Random speed modifier for variability
        car.AddComponent<CarMovement2>().speed = baseSpeed * speedModifier; // Set the car's speed
